...
////Debug serialize
//std::string debug_serializeToString() {
//	std::string out = "";
//	out += meshName + " //meshName \n";
//	out += ::debug_vec3ToString(pos) + " //pos \n";
//	out += ::debug_vec3ToString(orientation) + " //orientation \n";
//	out += (double)(scale);// + " //scale \n";
//	out += "f //scale \n";
//	return out;
//}
