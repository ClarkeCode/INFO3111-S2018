...
//	glTextureSubImage2D( 
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, /*GL_MIRRORED_REPEAT*/ /*GL_CLAMP*/ GL_REPEAT );
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, /*GL_MIRRORED_REPEAT*/ /*GL_CLAMP*/ GL_REPEAT );
